...
public class UsersController {
	...
	public String registerUser(
			@Validated({ User.CreateValidationGroup.class }) @ModelAttribute(value = "user") User user,
	...
	public String changeEmail(
			@Validated({ User.ChangeEmailValidationGroup.class }) @ModelAttribute(value = "user") User user,
			BindingResult result, @RequestParam("currentPassword") String currentPassword,
	...
	public String changePassword(
			@Validated({ User.ChangePasswordValidationGroup.class }) @ModelAttribute(value = "user") User user,
			BindingResult result, @RequestParam("currentPassword") String currentPassword,
			RedirectAttributes redirectAttributes, ModelMap model) {
	...
	public String editProfile(
			@Validated({ User.ProfileInfoValidationGroup.class }) @ModelAttribute(value = "user") User user,
